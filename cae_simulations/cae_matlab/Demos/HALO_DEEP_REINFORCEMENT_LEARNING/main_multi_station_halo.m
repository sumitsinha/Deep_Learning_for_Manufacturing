...
% 1 1 1    
% ];
filenameX='pca_process_parameters_3.csv';
...
%%
nStation=length(stationData);
output_path='C:\Users\SINHA_S\Desktop\cross_member_datagen\Demos\Fixture simulation\Multi station\locator_halo\pca_data\';
run_id=0;
output_x=sprintf('%scop_pca_drl_x_3_%g.csv',output_path,run_id);
output_y=sprintf('%scop_pca_drl_y_3_%g.csv',output_path,run_id);
output_z=sprintf('%scop_pca_drl_z_3_%g.csv',output_path,run_id);
