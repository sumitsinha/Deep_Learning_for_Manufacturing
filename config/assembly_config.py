...
assembly_system = {	
        ...
        'test_kcc_files':['cross_member_samples_datagen2_test.csv'],
        ...
        'test_data_files_x':['DX_crossmember_test2_11.csv'],
        'test_data_files_y':['DY_crossmember_test2_11.csv'],
        'test_data_files_z':['DZ_crossmember_test2_11.csv'],
        }
