...
assembly_system = {	
        ...
        'kcc_files':['inner_rf_samples_datagen1_set.csv','inner_rf_samples_datagen2_set.csv'],
        'test_kcc_files':['inner_rf_samples_datagen2_set.csv'],
        'data_files_x':['VRM-m-Stageoutput_table_x_datagen1_3.csv','VRM-m-Stageoutput_table_x_datagen2_3.csv'],
        'data_files_y':['VRM-m-Stageoutput_table_y_datagen1_3.csv','VRM-m-Stageoutput_table_y_datagen2_3.csv'],
        'data_files_z':['VRM-m-Stageoutput_table_z_datagen1_3.csv','VRM-m-Stageoutput_table_z_datagen2_3.csv'],
        'test_data_files_x':['output_table_x_test_demo_3.csv'],
        'test_data_files_y':['output_table_y_test_demo_3.csv'],
        'test_data_files_z':['output_table_z_test_demo_3.csv'],
        }
