...
def train_fold(model, train_gen, test_gen, es, epochs):
    ...
    print("Validation Accuracy for fold: ", test_acc)
...
for i, (train_index, test_index) in enumerate(stratified_folds):
    ...
    train_gen, test_gen = get_generators(
        train_index, test_index, graph_labels, batch_size=batch_size
    )
...
df = pandas.DataFrame(data={"Validation_MAE": test_accs})

df.to_csv(logs_path+"./val_mae.csv", sep=',',index=False)
